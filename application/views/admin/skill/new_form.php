            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php base_url('admin/skill/add') ?>" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?php echo form_error('name') ? 'is-invalid':'' ?>" id="name" placeholder="Name Skill" name="name">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control <?php echo form_error('persen') ? 'is-invalid':'' ?>" id="editor1" style="width: 100%" name="persen"></textarea>
                    <div class="invalid-feedback">
