...
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambahkan Data</button>
<br/>
<br/>
...
<table class="table table-hover">		
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysqli_query($koneksi,"select * from penerbit where penerbit='cari'");
	}else{
